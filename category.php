...
<tr><td style="font-family:Lucida Calligraphy; font-size:0px; color:#09F"><b>Category</b></td></tr>
<?php

$cn=mysqli_connect("localhost","root","","db_travel2");
...
while($data=mysqli_fetch_array($result))
{
		...
		echo "<tr><td style=' padding:5px; font-family:cambria; font-size:15px'><b><a href='subcat.php'>Subcategories</a></b></td></tr>";
